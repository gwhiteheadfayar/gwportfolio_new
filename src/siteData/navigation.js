export const navigationSections = [
    {
        id: "resume",
        label: "R",
        color: "#B933AD", // Red for Resume
        title: "Resume",
        content: "Below is my formal resume. Feel free to take a look!",
    },
    {
        id: "projects",
        label: "P",
        color: "#FCCC0A", // Yellow for Projects
        title: "Projects",
    ...
    },
    {
        id: "linkedin",
        label: "L",
        color: "#006983", // Blue for LinkedIn
        title: "LinkedIn",
    ...
    },
    {
        id: "experience",
        label: "E",
        color: "#009B3A", // Green for Experience
        title: "Experience",
        content: "I've worked at various companies! Check them out below.",
    },
    {
        id: "about",
        label: "A",
        color: "#FF6319", // Orange for About Me
        title: "About Me",
